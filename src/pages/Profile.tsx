...
import { User, Settings, Target, Bell, Crown, Smartphone, Globe, Shield, Download, Lock, Trash2 } from "lucide-react";
...
const Profile = () => {
  ...
  const handleDownloadData = async () => {
    try {
      ...
      a.href = url;
      a.download = `gymjm-dados-${new Date().toISOString().split('T')[0]}.json`;
    ...
    <Layout>
      <div className="p-3 md:p-4 pb-24 md:pb-4 space-y-4 md:space-y-6 max-w-4xl mx-auto overflow-x-hidden">
        ...
        <GymCard
          variant="nutrition"
          title="Plano Premium"
          description="Aproveite todos os recursos do GymJM"
        >
          <div className="space-y-4">
